<header>
  ...
  if (isset($_COOKIE['jwt'])) {
    ...
    if (estadoAcceso($_COOKIE['jwt'], $_ENV['SIGNATURE_KEY'], $_ENV['CIPHER_KEY'])) {
      ...
      echo "<a href='./user_info.php'><img class='redondeado' src='" . $infoUsuario['imagen'] . "'></a>";
