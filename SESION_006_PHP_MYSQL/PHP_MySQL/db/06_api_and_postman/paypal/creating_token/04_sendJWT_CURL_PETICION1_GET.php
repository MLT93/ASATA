...
// Inicio CURL y realizo la petición de tipo GET para crear el Token JWT y enviar las credenciales a través de Basic Authentication en el Header, y además otras variables en las Query Params
