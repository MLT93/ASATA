...
<head>
  ...
  <link rel="stylesheet" href="../03_panel_gameclub/css/style_gameclub.css" />
...
$connection = new DB("localhost", "root", "mysql", "gameclub");
?>
...
<body>
  <main>
    ...
    <!-- Alquileres -->
    <form action="./panel_gameclub.php" method="post" target="_self">
      <fieldset>
...
if (isset($_POST["submitAlquiler"])) {
  ...
  header("Location: panel_gameclub.php");
}
