<?php
/* Esta clase va a gestionar la tabla `actividades` */
...
class Actividad
{
  ...
  {
    $consultaSQL = "SELECT * FROM actividades;"; // Aquí saco toda la información necesaria. Además de la info entre las tablas relacionadas por sus Foreign Keys 
  ...
  public function add($id_tipo, $nombre, $consumo_Kcal_hora, $descripcion)
  {
    $consultaSQL = "INSERT INTO actividades (id_tipo, nombre, consumo_Kcal_hora, descripcion) VALUES
    ...
    */
    $consultaPrepare->bind_param("iisss", $id_tipo, $nombre, $consumo_Kcal_hora, $descripcion);
  ...
  {
    $id = intval($_GET['id']);
    $consultaSQL = "SELECT * FROM actividades 
