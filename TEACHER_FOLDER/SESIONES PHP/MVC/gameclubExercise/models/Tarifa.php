<?php
/* Esta clase va a gestionar la tabla `tarifas` */
...
class Tarifa
{
  ...
  {
    $consultaSQL = "SELECT * FROM tarifas;"; // Aquí saco todos los productos y sus Foreign Keys asociados
  ...
  {
    $consultaSQL = "SELECT * FROM tarifas WHERE tarifas.id = $id;"; // Aquí saco el producto a través de su ID y sus Foreign Keys asociados
