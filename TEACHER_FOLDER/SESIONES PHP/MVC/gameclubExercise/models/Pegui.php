<?php
/* Esta clase va a gestionar la tabla `pegui` */
...
class Pegui
{
  ...
  {
    $consultaSQL = "SELECT * FROM pegui;"; // Aquí saco todos los productos y sus Foreign Keys asociados
  ...
  {
    $consultaSQL = "SELECT * FROM pegui WHERE pegui.id = $id;"; // Aquí saco el producto a través de su ID y sus Foreign Keys asociados
