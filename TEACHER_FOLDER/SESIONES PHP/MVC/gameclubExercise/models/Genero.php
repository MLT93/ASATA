<?php
/* Esta clase va a gestionar la tabla `generos` */
...
class Genero
{
  ...
  {
    $consultaSQL = "SELECT * FROM generos;"; // Aquí saco todos los productos y sus Foreign Keys asociados
  ...
  {
    $consultaSQL = "SELECT * FROM generos WHERE generos.id = $id;"; // Aquí saco el producto a través de su ID y sus Foreign Keys asociados
