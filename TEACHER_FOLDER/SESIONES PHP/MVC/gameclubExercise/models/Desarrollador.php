<?php
/* Esta clase va a gestionar la tabla `desarrolladores` */
...
class Desarrollador
{
  ...
  {
    $consultaSQL = "SELECT * FROM desarrolladores;"; // Aquí saco todos los productos y sus Foreign Keys asociados
  ...
  {
    $consultaSQL = "SELECT * FROM desarrolladores WHERE desarrolladores.id = $id;"; // Aquí saco el producto a través de su ID y sus Foreign Keys asociados
