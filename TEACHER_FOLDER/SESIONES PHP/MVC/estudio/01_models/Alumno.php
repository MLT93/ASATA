<?php
/* Esta clase va a gestionar la tabla `alumnos` */
...
class Alumno
{
  ...
  public function getAll()
  {
    ...
    FROM alumnos 
    INNER JOIN grupos ON alumnos.id_grupo = grupos.id;"; // Aquí saco toda la información necesaria. Además de la info entre las tablas relacionadas por sus Foreign Keys
