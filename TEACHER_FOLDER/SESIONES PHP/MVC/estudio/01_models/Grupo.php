<?php
/* Esta clase va a gestionar la tabla `grupos` */
...
class Grupo
{
  ...
  {
    $consultaSQL = "SELECT id, tag FROM grupos;"; // Aquí saco toda la información necesaria. Además de la info entre las tablas relacionadas por sus Foreign Keys
  ...
  // {
  //   $consultaSQL = "INSERT INTO grupos (tag) VALUES (?);"; // Para preparar esta consulta, los valores vacíos de VALUES deben escribirse como `?` porque utilizamos la class `\mysqli`
  ...
  //   */
  //   $consultaPrepare->bind_param("s", $tag);
